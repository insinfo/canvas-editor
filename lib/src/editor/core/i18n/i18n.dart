// TODO: Translate from C:\MyTsProjects\canvas-editor\src\editor\core\i18n\I18n.ts
import 'dart:convert';
...
class I18n {
	...
	void registerLangMap(String locale, Map<String, dynamic> lang) {
	...
	Map<String, dynamic> getLang() => _langMap[_currentLocale] ?? _langMap['zhCN']!;
