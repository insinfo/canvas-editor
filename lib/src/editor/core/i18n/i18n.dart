...
const Map<String, dynamic> _ptBrLang = {
  'contextmenu': {
    ...
    'table': {
      ...
      'splitVerticalCell': 'Dividir verticalmente',
      'splitHorizontalCell': 'Dividir horizontalmente',
      'repeatHeaderRow': 'Repetir linhas de cabeçalho',
...
const Map<String, dynamic> _zhCnLang = {
  'contextmenu': {
    ...
    'table': {
      ...
      'splitVerticalCell': '垂直拆分',
      'splitHorizontalCell': '水平拆分',
...
const Map<String, dynamic> _enLang = {
  'contextmenu': {
    ...
    'table': {
      ...
      'splitVerticalCell': 'Split vertically',
      'splitHorizontalCell': 'Split horizontally',
      'repeatHeaderRow': 'Repeat header rows',
